...
import { resolveProviderCompatibilityMode } from "../anthropic-oauth-compat.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  try {
    ...
    const modelAuthMode = resolveModelAuthMode(model.provider, params.config);
    const providerCompatibilityMode = resolveProviderCompatibilityMode({
